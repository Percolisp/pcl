                                                                                                    ...
                                                                                                    (progn
                                                                                                      (let (($dnb (make-p-box nil)) ($dsig (make-p-box nil)) ($ddbe (make-p-box nil)))
                                                                                                        (let ((--pcl-if-ret--9 nil))
                                                                                                          ...
                                                                                                          ;; if ($dnb)
                                                                                                          (p-if (setf --pcl-if-ret--9                                     $dnb)
                                                                                                                (progn
                                                                                                                  ;; $$result_ref .= _pack_emit_int($dlen, $dnb, $dsig, $dbe2 ? 1 : ($dle2 ? 0 : $ddbe))
                                                                                                                  (setf --pcl-if-ret--9                                         (p-.= (p-cast-$ $result_ref) (let ((*wantarray* nil)) (pl-_pack_emit_int $dlen $dnb $dsig (p-if $dbe2 1 (p-if $dle2 0 $ddbe))))))
                       ...
                       (p-for (                (p-my-= $i 0))
                              ...
                              (let (($c (make-p-box nil)))
                                (let ((--pcl-if-ret--10 nil))
                                  ...
                                  ;; if ($c eq '[')
                                  (p-if (setf --pcl-if-ret--10                         (p-str-eq $c "["))
                                        (progn
                                          ;; $n_open++
                                          (setf --pcl-if-ret--10                             (p-post++ $n_open))
                                        ...
                                        (p-if (setf --pcl-if-ret--10                           (p-str-eq $c "]"))
                                              (progn
                                                ;; $n_close++
                                                (setf --pcl-if-ret--10                               (p-post++ $n_close))
...
"))
                                                        ...
                                                        (p-if (setf --pcl-if-ret--11                                   (p-str-eq $c ")"))
                                                              (progn
                                                                ...
                                                                (p-if (setf --pcl-if-ret--11                                       (p-&& @stk (p-str-eq (p-aref @stk -1) "(")))
                                                                      (setf --pcl-if-ret--11                                       (p-pop @stk))
                                                                      nil)
                     ...
                     (let (($k (make-p-box nil)))
                       (p-for (                (p-my-= $k 1))
                              ...
                              (let ((--pcl-if-ret--12 nil))
                                ...
                                (p-if (setf --pcl-if-ret--12                       (p-< (p-+ (p-cast-$ $si_ref) $k) $slen))
                                      (setf --pcl-if-ret--12                       (p-my-= $code (p-bit-or (p-<< $code 6) (p-bit-and (p-ord (p-substr $s (p-+ (p-cast-$ $si_ref) $k) 1)) #x3F))))
                                      nil)
               ...
               (let (($ch (make-p-box nil)) ($nrep (make-p-box nil)) ($all (make-p-box nil)) ($s__lex__1 (make-p-box nil)) ($si_ref__lex__2 (make-p-box nil)) ($push_val (make-p-box nil)) ($checksum_p (make-p-box nil)))
                 ...
                 (let (($slen__lex__3 (make-p-box nil)))
                   ...
                   (let (($n (make-p-box nil)) ($raw (make-p-box nil)) ($hex (make-p-box nil)) ($b (make-p-box nil)) ($nbits (make-p-box nil)) ($bits (make-p-box nil)) ($decoded (make-p-box nil)) ($lc (make-p-box nil)) ($nb (make-p-box nil)) ($ng (make-p-box nil)) ($get (make-p-box nil)) ($cm (make-p-box nil)) ($done (make-p-box nil)) ($v (make-p-box nil)) ($more (make-p-box nil)))
                     ...
                     ;; if ($ch eq 'A' || $ch eq 'a' || $ch eq 'Z')
                     (p-if (setf --pcl-if-ret--13                 (p-|| (p-|| (p-str-eq $ch "A") (p-str-eq $ch "a")) (p-str-eq $ch "Z")))
                           (progn
                             (let (($n (make-p-box nil)) ($raw (make-p-box nil)))
                               ...
                               ;; $push_val->($raw)
                               (setf --pcl-if-ret--13                       (let ((*wantarray* nil)) (p-funcall-ref $push_val $raw)))
                               
                               )
                             )
                           ;; elsif ($ch eq 'H')
                           (p-if (setf --pcl-if-ret--13                   (p-str-eq $ch "H"))
                                 (progn
                                   (let (($n (make-p-box nil)) ($hex (make-p-box nil)) ($i (make-p-box nil)) ($b (make-p-box nil)))
                                     ...
                                     ;; $push_val->($hex)
                                     (setf --pcl-if-ret--13                         (let ((*wantarray* nil)) (p-funcall-ref $push_val $hex)))
                                 ...
                                 (p-if (setf --pcl-if-ret--13                     (p-str-eq $ch "h"))
                                       ...
                                       ;; elsif ($ch eq 'B')
                                       (p-if (setf --pcl-if-ret--13                       (p-str-eq $ch "B"))
                                             (progn
                                               (let (($nbits (make-p-box nil)) ($i (make-p-box nil)) ($b (make-p-box nil)) ($bits (make-p-box nil)))
                                                 ...
                                                 (setf --pcl-if-ret--13                             (p-incf (p-cast-$ $si_ref__lex__2) (p-int (p-/ (p-+ $nbits 7) 8))))
                                             ...
                                             (p-if (setf --pcl-if-ret--13                         (p-str-eq $ch "b"))
                                                   ...
                                                   ;; elsif ($ch eq 'u')
                                                   (p-if (setf --pcl-if-ret--13                           (p-str-eq $ch "u"))
                                                         (progn
                                                             ...
                                                             (p-while (p-< (p-cast-$ $si_ref__lex__2) $slen__lex__3)
                                                                      (let (($lc (make-p-box nil)) ($nb (make-p-box nil)) ($ng (make-p-box nil)) ($k (make-p-box nil)) ($get (make-p-box nil)) ($cm (make-p-box nil)))
                                                                        (let ((--pcl-if-ret--14 nil))
                                                                            ...
                                                                            (p-for (                                      (p-my-= $k 0))
                                                                                   ...
                                                                                   (let (($get (make-p-box nil)) ($cm (make-p-box nil)))
                                                                                     (let ((--pcl-if-ret--15 nil))
                                                                                       ...
                                                                                       (p-if (setf --pcl-if-ret--15                                               (p-< (p-+ (p-* $k 3) 2) $nb))
                                                                                             (setf --pcl-if-ret--15                                               (p-.= $decoded (p-chr (p-bit-and $cm #xFF))))
                                                                                             nil)
                                                                          ...
                                                                          (p-if (setf --pcl-if-ret--14                                       (p-&& (p-< (p-cast-$ $si_ref__lex__2) $slen__lex__3) (p-str-eq (p-substr $s__lex__1 (p-cast-$ $si_ref__lex__2) 1) "
")))
                                                                                (setf --pcl-if-ret--14                                       (p-post++ (p-cast-$ $si_ref__lex__2)))
                                                                                nil)
                                                             ...
                                                             ;; $push_val->($decoded)
                                                             (setf --pcl-if-ret--13                                 (let ((*wantarray* nil)) (p-funcall-ref $push_val $decoded)))
                                                         ...
                                                         (p-if (setf --pcl-if-ret--13                             (p-str-eq $ch "U"))
                                                               ...
                                                               ;; elsif ($ch eq 'W')
                                                               (p-if (setf --pcl-if-ret--13                               (p-str-eq $ch "W"))
                                                                     (progn
                                                                  ...
                                                                  (p-if                             $bang
                                                                                                    ...
                                                                                                    (progn
                                                                                                      (let ((--pcl-if-ret--16 nil))
                                                                                                        ...
                                                                                                        (p-if (setf --pcl-if-ret--16                                   (p-< (p-cast-$ $si_ref) 0))
                                                                                                              (setf --pcl-if-ret--16                                   (p-setf (p-cast-$ $si_ref) 0))
                                                                                                              nil)
...
;; Override transpiled _unpack_read_int with exact CL integer arithmetic.
;; p-** uses double-float (expt 2.0d0 64.0d0) which loses precision for 64-bit
;; values: 2^64-1 and 2^64 both round to the same double, so v-=max gives 0.0
;; instead of -1. Using ash gives exact bignums throughout.
(defun pl-_unpack_read_int (&rest %_args)
  (let* ((@_ (pcl::p-flatten-args %_args))
         (s   (aref @_ 0))
         (si  (pcl::to-number (aref @_ 1)))
         (nb  (pcl::to-number (aref @_ 2)))
         (be  (aref @_ 3))
         (sig (aref @_ 4))
         (slen (pcl::to-number (pcl::p-length s)))
         (sv (pcl::to-string s))
         (v 0))
    (if (pcl::p-true-p be)
        (loop for k from 0 below nb do
              (setf v (logior (ash v 8)
                              (if (< (+ si k) slen)
                                  (char-code (char sv (+ si k)))
                                  0))))
        (loop for k from (1- nb) downto 0 do
              (setf v (logior (ash v 8)
                              (if (< (+ si k) slen)
                                  (char-code (char sv (+ si k)))
                                  0)))))
    (when (pcl::p-true-p sig)
      (let ((bits (* nb 8)))
        (when (>= v (ash 1 (1- bits)))
          (decf v (ash 1 bits)))))
    v))
