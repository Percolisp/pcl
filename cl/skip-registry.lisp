...
;; index.t 49-58 (the ten `:utf8` octet-vs-character registrations) were DROPPED
;; in s470br: #1221 made `utf8::encode`/`decode`/`downgrade` really transform the
;; string, so index/rindex do see octet offsets and all ten reported
;; REGISTRY-STALE.  What is still absent is the per-scalar UTF-8 FLAG itself
;; (`utf8::is_utf8` always answers 1) -- docs/not-supported.md, "Unicode
