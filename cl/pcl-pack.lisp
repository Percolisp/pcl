                            ...
                            (let (($r (make-p-box nil)))
                              (p-for (                            (p-my-= $r 0))
                                ...
                                (let (($v (make-p-box nil)) ($nv (make-p-box nil)))
                                  ...
                                  (let ((*wantarray* :void)) (p-if                                   (p-!= $nv $nv)                                   (p-die "Cannot pack NaN in pack
")))
                                  
                                  ;; die "Cannot pack " . ($nv < 0 ? "-Inf" : "Inf") . " in pack\n" if $nv != 0 && $nv == $nv * 2
                                  (let ((*wantarray* :void)) (p-if                                   (p-&& (p-!= $nv 0) (p-== $nv (p-* $nv 2)))                                   (p-die (p-. (p-. "Cannot pack " (p-if (p-< $nv 0) "-Inf" "Inf")) " in pack
"))))
                            ...
                            (let (($r (make-p-box nil)))
                              (p-for (                            (p-my-= $r 0))
                                ...
                                (let (($raw (make-p-box nil)) ($orig_s (make-p-box nil)) ($v (make-p-box nil)) (@bytes (make-array 0 :adjustable t :fill-pointer 0)) ($k (make-p-box nil)))
                                  ...
                                  (let ((*wantarray* :void)) (p-if                                   (p-!= $v $v)                                   (p-die "Cannot compress NaN in pack
")))
