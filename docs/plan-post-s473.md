...
| — | Fable designs | #1117 typeglob slots — **DESIGNED s480 (in the task: (A) exact 3–5 % vs (B) zero-cost side table with a documented read-revivification residue; Fable recommends (B); USER decision open)**; #582 `@ISA`-write invalidation (USER: box magic?); #71 PCRE2 (from s473p's measurement); #1202 extension fasl (USER-parked with pack) | | |
