...
## PCL: Tests 53-59 commented out — these use eval("my $x if 0") to detect invalid Perl.
## PCL is a transpiler for valid Perl only; per principle 9, it does not validate or
## reject invalid constructs. Same rationale as for.t tests 131-138.
# # RT # 133543
