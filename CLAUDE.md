...
2e. **`docs/plan-post-s400.md` §2c (Fable, s406, 2026-08-16): the s405 review request is DEFERRED to the next batch — Opus 5 does NOT wait for `fable-answers-s405.md`; queue continues at #348, the six s405 asks have interim standings there (all = as shipped; #360 do-not-start, #359 behind the release).**
