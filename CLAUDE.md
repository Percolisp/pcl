...
- **133 test files, 4788 tests** with a built pclxs sibling (s379, measured);
  **4774 without** (arithmetic: minus the 14 xs rows).  The gate count is deterministic *per environment*, but it
