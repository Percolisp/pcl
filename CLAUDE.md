...
- **131 test files, 4656 tests** with a built pclxs sibling (s354, measured);
  **4642 without** (arithmetic: minus the 14 xs rows).  The gate count is deterministic *per environment*, but it
