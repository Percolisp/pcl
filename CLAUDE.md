...
- **131 test files, 4652 tests** with a built pclxs sibling (s351, measured);
  **4638 without** (arithmetic: minus the 14 xs rows).  The gate count is deterministic *per environment*, but it
