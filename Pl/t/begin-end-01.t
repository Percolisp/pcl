...
END_CODE
  ...
  like($output, qr/\bdefault\b/, 'runtime our-init overwrites compile-time BEGIN (matches perl)');
  unlike($output, qr/from_begin/, 'BEGIN value does not survive the runtime init');
}
